...
const ProductDescriptionAndAddtoCart = ({ image, title, rating, reviewCount, description, descriptionTab, reviews, descriptionImages, product }) => {
...
export default ProductDescriptionAndAddtoCart;